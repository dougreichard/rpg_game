...
STYLE = (", flat shading, simple solid colors, minimal geometric detail, Synty "
         "low-poly 3D game asset style, soft even studio lighting, plain light "
         "grey seamless background, centered, whole object in frame, front "
         "three-quarter view")
NEG = ("realistic, photograph, photorealistic, high detail, busy background, text, "
       "watermark, logo, person, hands, blurry, cropped, dark, harsh shadows")
