...
func save_game() -> void:
	...
	cfg.set_value("progress", "last_building_visited", GameManager.last_building_visited)
...
func load_game(slot: int) -> bool:
	...
	GameManager.last_building_visited = cfg.get_value("progress", "last_building_visited", "")
